<section id="reviews">
    <div class="wrap">
        <div class="left">
            <div class="total-rev">
                <span>Ocena:</span>
                <?php if(get_field('ocena')) { ?>
                <div class="ocena"><?php the_field('ocena')?></div>
                <?php } ?>
            </div>
            <div class="log-google">
                <?php if(get_field('ilosc_ocen_w_google')) { ?>
                <span><?php the_field('ilosc_ocen_w_google')?></span>
            ...
            <div class="buttony">
                <a class="btn btn-main " href="https://www.google.com/search?q=global+car+wash+warszawa&client=opera&hs=DEg&sxsrf=AOaemvI4ZJTGd_92hLsoRSAQ2iwEEE6MMQ%3A1632138617961&ei=eXVIYc-GOsKUjLsPz-2DuA4&oq=global+car+wash+warszawa&gs_lcp=Cgdnd3Mtd2l6EAMyBAgjECc6BwgAEEcQsAM6BQgAEIAEOgsILhCABBDHARCvAToGCAAQFhAeSgQIQRgAUKYDWNMUYK8WaABwA3gAgAFqiAHuBZIBAzguMZgBAKABAcgBCMABAQ&sclient=gws-wiz&ved=0ahUKEwiPp7CUvo3zAhVCCmMBHc_2AOcQ4dUDCA0&uact=5#lrd=0x471933d135f47bff:0x3790c2ecd149862f,1,,," target="_blank">Pokaż więcej opini</a>
                <a class="btn btn-revers" href="https://www.google.com/search?q=global+car+wash+warszawa&client=opera&hs=DEg&sxsrf=AOaemvI4ZJTGd_92hLsoRSAQ2iwEEE6MMQ%3A1632138617961&ei=eXVIYc-GOsKUjLsPz-2DuA4&oq=global+car+wash+warszawa&gs_lcp=Cgdnd3Mtd2l6EAMyBAgjECc6BwgAEEcQsAM6BQgAEIAEOgsILhCABBDHARCvAToGCAAQFhAeSgQIQRgAUKYDWNMUYK8WaABwA3gAgAFqiAHuBZIBAzguMZgBAKABAcgBCMABAQ&sclient=gws-wiz&ved=0ahUKEwiPp7CUvo3zAhVCCmMBHc_2AOcQ4dUDCA0&uact=5#lrd=0x471933d135f47bff:0x3790c2ecd149862f,3,,," target="_blank">Napisz opinię</a>
            </div>
        </div>
        <div class="right">
            <div class="header-rew">
                <h3>Co onas mówią?</h3>
                <div class="arrow">
